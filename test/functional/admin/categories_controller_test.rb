...
class Admin::CategoriesControllerTest < ActionController::TestCase
  ...
  test "simple user souldn't show category" do
    ...
    get :show, :id => categories(:Wood).to_param
  ...
  test "simple user shouldn't get edit" do
    ...
    get :edit, :id => categories(:Wood).to_param
  ...
  test "simple user shouldn't update category" do
    ...
    put :update, :id => categories(:Wood).to_param, :category => { :name => 'Foobar' }
  ...
  test "simple user shouldn't destroy category" do
    ...
    assert_no_difference('Category.count') do
      delete :destroy, :id => categories(:Wood).to_param
    end
