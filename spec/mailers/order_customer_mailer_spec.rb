...
describe OrderCustomerMailer do
  let(:order) { create(:quote_validation_order) }

  describe 'created' do
    let(:email) { OrderCustomerMailer.created(order.id) }
  ...
  describe 'quote_validation' do
    let(:email) { OrderCustomerMailer.quote_validation(order.id) }
  ...
  describe 'preparation' do
    let(:email) { OrderCustomerMailer.preparation(order.id) }
  ...
  describe 'delivery' do
    let(:email) { OrderCustomerMailer.delivery(order.id) }
  ...
  describe 'complete' do
    let(:email) { OrderCustomerMailer.complete(order.id) }
  ...
  describe 'cancel' do
    let(:email) { OrderCustomerMailer.cancel(order.id) }
